...
async def saves():
    ...
    try:
        ...
        await jmub(JoinChannelRequest("@jmthon_help"))
        ...
        try:
            if BOTLOG:
                await jmub.tgbot.send_message(
                    BOTLOG_CHATID,
                    "**لقد تم بنجاح تنصيب سورس جمثون **\n➖➖➖➖➖➖➖➖➖➖\n**السورس**: @AAAND21\n**المطور**: @amir7119\n➖➖➖➖➖➖➖➖➖➖\n**مجموعة الدعم**: @AAAND21\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        (Button.url("كروب المساعدة", "https://t.me/AAAND21"),)
                    ],
                )
        except Exception as e:
            LOGS.error(e)
...
مجموعة المساعدة: @AAAND21""",
    4: f"""• `لمعرفة جميع اوامر السورس ارسل`
  - `.اوامري`
  - `.الاوامر`""",
    5: """• **لأي مساعدة ثانية **
  - أنضم في مجموعة المساعدة **@AAAND21**.
